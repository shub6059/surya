...
/*
* Template Name: All Doctors Page
*
*/
...
.doc-filters select {
	...
	@media all and (min-width:991px){
		img.img-responsive.doctor-pic.main-pic {
    height: 170px;
    width: unset;
    object-position: top;
    object-fit: cover;
...
<div class="doctor-search">
	...
	<input id="search-doctor" type="text" placeholder="Search Doctor">
        ...
        <?php
            ...
            if ( $the_query_doctor->have_posts() ) {
              ...
              ?>
				...
				<div class="doc-content<?php if($doct_count > 14){ echo ' hidden'; } ?>" data-name="<?php echo get_the_title(); ?>" data-date="<?php echo get_the_date( 'ymd' ); ?>" spec-id="<?php for($i=0;$i<count($specialities);$i++){
                if($i>0){
                echo ',';
                }
                echo $specialities[$i];
			        ...
			        <div class="doctor-info dr">
			          <h2 class="doctor-name"><a href="<?php echo get_the_permalink(); ?>"><?php echo get_the_title(); ?></a></h2>
			          <p class="education hide-text">
<?php $edu = get_field('qualification'); 
$edu1 = implode(' ', array_slice(explode(' ', $edu), 0, 5))."\n"; 
$edu2 = implode(' ', array_slice(explode(' ', $edu), 5))."\n"; 
echo $edu1; 
?>
<span class="read-more-content">
<?php echo $edu2; ?>
<a class="read--less">read less</a></span><a class="read--more">read more</a></p>
...
<!-- 			          <a href="tel:+918956455150" class="btn btn-contact">Contact Hospital</a> -->
	     ...
	     <?php 
          ...
          <?php
            ...
            $the_query_doctor_1 = new WP_Query( $get_doctor_list_1 );

            if ( $the_query_doctor_1->have_posts() ) {
              while ( $the_query_doctor_1->have_posts() ) {
                  $the_query_doctor_1->the_post();
                  $specialities = get_field('speciality');
              ?>
...
<!-- 			          <a href="tel:+918956455150" class="btn btn-contact">Contact Hospital</a> -->
	...
	<div class="view-all-btn"><button class="view-all-doctor">View All</h2></div>
	...
	$(document).ready(function(){
		...
		if($('.doc-container').children(':visible').length == 0) {
		 ...
		 $("#search-doctor").on("keyup", function() {
		    ...
		    $(".doc-container .doc-content").filter(function() {
