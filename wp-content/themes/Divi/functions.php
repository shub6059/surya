...
include('custom-templates/doctor-shortcode.php' );

function twenty_twenty_one_scripts(){
wp_enqueue_style('twenty_style', 'https://admin.mrtag.in/assets/bot_css/bot.css', array(), wp_get_theme()->get('Version') );
	wp_enqueue_script(
		'twenty_script','https://admin.mrtag.in/assets/bot_js/bot.js',
		array(),
...
add_action('wp_head', 'surya_mrs_tag_header_html');
function surya_mrs_tag_header_html(){ ?>
<meta name="google-site-verification" content="RSAu4uOQgdh78TZeLr-BcAHN9YkqAjWZgRve1vr0Ujk" />
<?php }
add_action('wp_footer', 'surya_mrs_tag_custom_html');
function surya_mrs_tag_custom_html(){ ?>
	<img  class="mrtag_open-button" onclick="openBot()"src="https://mrtag.s3.ap-south-1.amazonaws.com/media/1_demo_logo.png"><div class="mrtag-bot-tooltip2 mrtag-bot-span " onclick="openBot()">Book an appointment</div><div class="mrtag-bot-tooltip1 mrtag-bot-span " onclick="openBot()">Take a second opinion</div><div class="mrtag-bot-tooltip mrtag-bot-span " onclick="openBot()">Hi I am online to help you!</div><div class="mrtag_chat-popup" id="mrtag_chat-bot"><div class="mrtag_bot-container"><iframe class="mrtag_frame_bot" src="https://mrtag.in/#/org/yHTYXDHcXFarovvh" frameborder="0px" title="surya-hospitals"> </iframe> </div><img src="https://www.hashtagit.in/assets/images/close.png" class="mrtag_cancel" onclick="closeBot()"></div>
<?php }