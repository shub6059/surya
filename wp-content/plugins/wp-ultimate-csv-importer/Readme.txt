=== Import All Pages, Post types, Products, Orders, Users as XML & CSV ===
...
Tags: import, csv, importer, xml, migrate, content, CSV Import, demo import, wordpress, admin
License: GPLv2 or later 

Forget the hassle of manual data entry: Transform Your WordPress with the best Importer Plugin!
...
With our all-in-one ultimate import export bundle for WordPress, you can now quickly and conveniently import all types of content from XML and CSV files in fast and easy steps. Our plugin will help you save time and effort while still ensuring accuracy and precision. Whether you’re an experienced developer or a novice user, this plugin is your perfect solution. 

[Try our free demo site here](https://demo.smackcoders.com/ultimatecsvimporter/wp-admin/) to get started today – you won’t be disappointed!

You can [import all types of content from XML and CSV files directly](https://www.smackcoders.com/documentation/ultimate-csv-importer-pro/how-to-import-csv?utm_source=web&utm_campaign=readme&utm_medium=wp_org) with WP Ultimate CSV Importer Plugin. 
...
* Custom Posts created by CPT UI, Pods, Toolset, Jet Engine and Custom Press 
* [WooCommerce Products & bundle](https://wordpress.org/plugins/import-woocommerce) * Available as Add On
* [WP User & Members](https://wordpress.org/plugins/import-users) * available as Add On
* [WordPress all export](https://wordpress.org/plugins/wp-ultimate-exporter) Post, products, Orders, Refunds, Coupons, Taxonomies, Menus, WP User export and comments feature can be enabled as Add On

= Advanced Features that make life easy =
* Built-in drag and drop feature for easy content uploads with just a few steps
* Upload as zip compressed file from PC, URL, or FTP/SFTP 
* Visitors are notified when maintenance mode is in effect during import.

= Huge list of Plugins Supported =
* WordPress SEO Plugins: AIO SEO (free & pro), Rank Math SEO FREE, SEOPress (free & pro) & Yoast SEO.
* WooCommerce * WooCommerce Products are imported along with categories, tags, gallery images, and attributes.
...
* Meta Box Plugin * Basic & Limited Advanced fields
* Pods * CPT and All Fields
* Jet Engine * Basic fields
* Advanced custom fields (ACF): Basic, Choices, ACF repeater and jQuery fields


= What is WP import? =

It is a method that helps you to import your content from one WordPress database or instance to another. as a plugin

It allows to copy all the existing posts, pages and categories from an existing site into a new website. A plugin can do this by using the WordPress database as a source of information in your old site. It works with any database, including MySQL and PostgreSQL. You can then move the content into another website or blog.

This means that when you import using our plugin, you'll be able to use all the same posts, pages and categories that were already in your old site. You'll also have access to all the settings and options as configured on your old site before shutting down.

Our plugin has been around for 10 years now and it's still one of the most used plugins when it comes to importing content from WordPress sites. You can use this plugin to migrate your existing WordPress installation to a new one. Or even export  content, and  import or update your data in bulk.
...
= How to import file in wordpress =
...
* You can use the export option from existing content to create a base sample file or use it as a template to build your import file. 
...
* Take a safe DB back up before import in case a simple rollback may require 
* Always validate the file before the imports are processed 
...
* The same process should be repeated for remaining data rows in the uploaded file. 
* Finalize your file, go for the actual import.


= Few Simple Steps to Publish in Bulk =
Importing content in bulk can be done in a number of different ways depending on the source type, platform and file type. 
...
* Verify, confirm and click to process all the data in one go. 
* Review the real-time log and make sure that all posts created are accurate. 

View this video for detailed instructions on how to successfully publish content

[youtube https://www.youtube.com/watch?v=HHPpS0uZzeU&t=2s]


= What is Import and Export in WordPress? =

Importing and exporting are two different things. WordPress can import data from other sources, but it cannot export the data to another source. It is possible to export a WordPress  database using the wp_export_dump() function to back up your database tables in bulk. Other ways are suing plugin to export the data as XML, CSV or Json file formats

If the webmaster inconvenient with manual copying, then this is a welcome change. Instead of copying and pasting, simply drag and drop!

Importing content that is posts, pages and attachments is an extremely useful tool for building out sites with content from other sources. You can use it as an alternative to building SEO structures within your website, or add new products or services to existing sites.


= How to import WordPress site from localhost =

If you’re using XAMP or WAMP, it’s possible to export after development and customization  as XML or CSV from the export tab. You can trim using the advanced filters to exclude unwanted and unfinished items for migration. And now you can import the site to a remote host. 

You can also use this method when building new sites, develop it in localhost and need access to existing content on the old server.

This is also useful if you’ve moved your site to another server or hosting and want to move it back.
...
* No. of advance filters available to to narrow down your export
...
= WordPress Migration Step 2: WP All Import in few simple steps =
...
= Premium Features =
The WordPress Ultimate CSV Importer Pro offers powerful premium features to meet our users' different requirements. A few features are listed below:
...
* Ecommerce data likely WooCommerce, WPeCommerce.
* Toolset Types (Custom fields, Post Relation, Intermediate post, Repeatable Field & Repeater Field Group)
* Multi-Languages by WPML, qTranslate X, Polylang plugins.
* Yoast SEO Free & Pro plugin.
* Events Manager Free & Pro plugin.
* NextGEN Gallery plugin.
* ACF (Advanced custom fields) Free & Pro plugins
* Jet Engine
* CMB2 fields

Please visit [WordPress Importer & Export Premium Features here](https://www.smackcoders.com/wp-ultimate-csv-importer-pro.html?utm_source=web&utm_campaign=readme&utm_medium=wp_org) for more details and technical support via email.


= Learning Resources =
* Visit Documentation for [WordPress Importer Plugin features and Export ](https://www.smackcoders.com/documentation/ultimate-csv-importer-pro/how-to-import-csv?utm_source=web&utm_campaign=readme&utm_medium=wp_org)
...
* You may need some [example XML or CSV sample files](https://www.smackcoders.com/documentation/wp-ultimate-csv-importer-pro/csv-xml-samples?utm_source=web&utm_campaign=readme&utm_medium=wp_org) to understand the basics, to try or used to create your own set of files.


== Screenshots ==
1. Dashboard view of the WordPress ultimate importer.
2. Upload a XML or CSV file.
3. Simple Drag and Drop mapping.
4. Mapping view of the uploaded XML or CSV all imports field setup against WordPress fields.
5. Detailed real-time log.
6. Settings with php.ini details.
7. Downloadable log manager for all imported events.
8. WordPress XML All Import Option.
...
= Can I get any demo data or sample files for testing the import? =
  ...
  Get [example CSV files from here to start testing import](https://www.smackcoders.com/blog/wordpress-ultimate-csv-importer-csv-sample-files-and-updates.html?utm_source=web&utm_campaign=readme&utm_medium=wp_org) with WP Ultimate CSV Importer.
...
= Why does the export import media library WordPress plugin fails to import? that is not importing all images to WordPress media, no files found? =
...
To do this, add a separate column for featured images and mention the image URL. The inline images can be declared inside the post_content. Provide image URL using the <img> HTML tag inside post_content.

= How to import all external images in WordPress? =

  In the Media Handling section of the WordPress Importer plugin, you can enable the 'Download Post-Content External Images to Media' option for images from Google images, Pexels, Pixabay, Dropbox, etc. It will import all the images directly to your WordPress media library. Check Media Handling in WordPress Importer documentation for more information.
...
= How long does WordPress imports take? =

  The speed and performance is influenced by your server speed, memory capacity, and file size. You can track the completion time of import in the 'Import Configuration section' screen. 
...
= How to import and export WordPress posts? =
   ...
   Under the Export tab, select Posts. Provide a file name and select one file type. Click export and select the Download button to save that file in your local. You can use the exported file as a sample to prepare a new file or for importing the exported file in another WordPress instance with WP Ultimate CSV Importer to duplicate the data on that website.

   To import posts, upload the prepared CSV or XML file in the 'import/update' section. Then follow the steps mentioned in the WordPress Importer documentation.

= How to import a word document into wordpress =

If you have a Word document that you need to import into WordPress follow the steps explained below.

There are no viable solution or plugin available to directly import the docx or docs to WordPress. Instead use a tool or plugin like https://wordpress.org/plugins/mammoth-docx-converter   to convert  them into posts. Note that this is applicable for single post only.

There are three possible ways to do this manually by copy paste content from docs.
1. The first possibility to do that using Classic editor, go to Pages > Add New. Simply copy paste the content as one post by one
2. In case of Guttenberg editor, as explained previous step need to copy paste to create block by block
3. Or else you can embed a word document using a plugin.

= How to export wp users =
 Make sure the export addon is installed and activated in WordPress all export wp users from the plugin export tab

= Why I cannot see SEOPress fields in the mapping section? =

You need to Install and activate the SEOPress plugin <https://wordpress.org/plugins/wp-seopress/> first, otherwise it is not displayed. If needed you can deactivate and activate it again. If you have a cache plugin installed, make sure to clear the cache.

= how to import SEOPress plugin data using WP Ultimate CSV importer? =

Assuming you already have the required CSV or XML file to import.

The general steps you would need to follow are:
- Ensure the WP Ultimate CSV Importer and SEOPress plugin is Installed and activated on your WordPress site.
...
It is recommended to have a backup and test on a staging environment before importing on a live website.

= Where I can get the SEOPress data as csv or XML file? =

To import SEO Press data using the WP Ultimate CSV Importer plugin, you'll first need to export the data to a CSV or XML file. Or create one using an example file.

Steps to export
- In the plugin, go to the export section (tab)
- select what to export, here it is "post" for example 
- use available filters to limit the post counts
- choose an available format from CSV, XLS, XML, or JSON export file formats
- choose CSV as an option 
- and click to export the data 
- Now you can download the data in CSV format

Steps to create one
- Use the already exported file as a sample file 
- or get the example CSV file here.
- use this as base file and add required data row by row under the SEOPress field column

Here is a list of SEOPress fields and their matching values are 
- _seopress_titles_title- if empty,  SEOPress default template value will be applied- Redirection World SEOPress
- _seopress_titles_desc- Hello world SEOPress descriptions here- Desc Redirection World SEOPress
...
- _seopress_robots_canonical- should be an URL, default is own URL- 
...
- _seopress_redirections_value- should be an URL- https://www.seopress.org/
...
* Fixed: now install and manage addons directly from plugin interface
...
= 7.1 = 
* Resolved: PHPV8.0 check array values
...
= 6.5.5 =
* Added : support for Pods plugin

= 6.5.4 =
* Added : support for Meta Box plugin
...
* Fixed: drop box link image issue 
* Fixed: Language * English(South Africa) issue    

= 6.2.8 = 
* Added: support for image through drop box link  
...
* Added: Delete items not present in the XML, CSV files while import.
...
= 6.0.8 = 
* Added: Xml supports with more than one header mapping.
...
= 6.0.3 =
* Added: post_content image without downloaded into media option
...
= 6.0.2 =
* Fixed: posts imports struck in the first record
* Added: support for image through google drive 
...
* Updated: Exclude selection as include selection in the export module
* Fixed:  User import
...
* Added: Post Type imports with terms & taxonomies with any depth of the parent-child hierarchy.
...
* Fixed:  Category & Tag issue in eShop module.
...
* Added: Warning to guide the user to create uploads directory with writable permissions.
...
* Module based system allows simplifying UI
...
* Improved: Add a custom field option improved.
...
* Fixed:  Date format conflict Fixed: .
= 2.6.0 =
...
== Upgrade Notice ==
= 7.5 =
* Upgrade for bug fixes and LifterLMS import & export features

= 7.4 =
* Upgrade for minor bug fixes and woocommerce export features

= 7.3 =
* Upgrade for minor bug fixes and SEOPress import suite 

= 7.2 =
* Must upgrade now for WooCommerce Orders, Coupons, and Refunds import export improved usabilities and bug fixes
= 7.1 = 
* Must upgrade to avoid php version issues
= 7.0.1 = 
* Added: Arabic, Persian, Chinese(Simplified) and Tamil languages
= 7.0 =
* Added: Upgrade now for latest updates.
= 6.5.8 =
* Added: Upgrade to get security fix.
= 6.5.7 =
* Added: Upgrade now to get support for Jet Engine basic fields.
= 6.5.6 =
* Added: Upgrade now for latest updates.
= 6.5.5 =
* Added: Upgrade now for latest updates.
...
* Added: Upgrade now for latest updates.
= 6.5 =
* Added: Upgrade now for latest WP Compatibility and features.
= 6.4.4 =
* Added: Upgrade now for latest WP Compatibility.
= 6.4.3 =
* Added: Upgrade now for vulnerability fixes.
= 6.4.2 =
* Added: Upgrade now for security fixes.
= 6.4.1 =
* Added: Upgrade now for latest updates.
= 6.4 =
* Added: Upgrade now for latest updates.
...
= 6.0.3 =         
* Upgrade now for a much improved and stable release
= 6.0.2 =
...
= 5.3 =
* Major improvements and fix updates, verify changelog for an upgrade.
= 5.2 =
* Upgrade now to get an enhanced User Interface and support for the latest version of All in one SEO. 2.3.12.1.
= 5.1.1 =
* Upgrade now to get the fix for the duplicate handling feature.
= 5.1 =
...
= 3.9.3 =
* Upgrade now to get support for custom port id in the MAMP environment and WordPress 4.5 compatibility.
= 3.9.2 =
...
= 3.8.6 =
* Upgrade now to import the default CPTs.
= 3.8.5 =
* Upgrade now for known bug fixes.
= 3.8.4 =
* Upgrade now for a new dashboard view.
= 3.8.3 =
...
= 3.7.4 =
* Upgrade now to allow author/editor fix.
= 3.7.3 =
...
= 3.6.75 =
* Upgrade now for an improved experience.
= 3.6.74 =
* Upgrade now for security fix.
= 3.6.73 =
...
= 3.6.71 =
* Upgrade now for complete export features as in Pro with a bug fix.
= 3.6.7 =
* Upgrade now for complete export features as in Pro.
= 3.6.6 =
* Upgrade now for an improved experience.
= 3.6.5 =
* Upgrade Now for advanced media handling for the post inline images
= 3.6.4 =
...
= 3.5.4 =
* Upgrade now for All in SEO Pack support.
= 3.5.3 =
* Upgrade to add export feature and fix the bug.
= 3.5.2 =
...
* Added more information in the success message.
