				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPSISAC_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e( 'Grab Slick Slider Now', 'wp-slick-slider-and-image-carousel' ); ?></a>
						</div>
					</div>
				</div>
			</div>
