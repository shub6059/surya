...
**Download now** and you will find title, content and image option in the admin side where you can create unlimited number of slides.

= Frontend Side =

We have added 5 designs for slider and 1 design for carousel. You can find all designs on our demo website. Just copy the shortcode of design that you like and use. so what you waiting for? **Download now** and try using slick slider.

**Also added Gutenberg block support.**

[Explore Slick Slider Features](https://demo.essentialplugin.com/slick-slider-demo/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Read-Me) | [Annual or Lifetime Bundle Deal](https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Read-Me)
