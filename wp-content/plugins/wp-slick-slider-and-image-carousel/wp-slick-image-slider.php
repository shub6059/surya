...
if( ! defined('WPSISAC_VERSION') ) {
	define( 'WPSISAC_VERSION', '3.3' ); // Plugin version
}
...
if( ! defined( 'WPSISAC_PLUGIN_LINK_UPGRADE' ) ) {
	define('WPSISAC_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}
