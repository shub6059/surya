...
class Smart_Post_Show {
	...
	public function define_constants() {
		...
		define( 'SP_PC_PATH', plugin_dir_path( dirname( __FILE__ ) ) );
		define( 'SP_PC_TEMPLATE_PATH', plugin_dir_path( dirname( __FILE__ ) ) . 'public/template/' );
		define( 'SP_PC_URL', plugin_dir_url( dirname( __FILE__ ) ) );
	}
