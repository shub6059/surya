...
if(isset($_POST)){
	...
	$subject = 'Paediatric Surgery Enquiry - Surya Hospitals Pune';

	$name = $_POST['name'];
	$email = $_POST['email'];
	$phone = $_POST['phone'];

	$message = "Hi New Paediatric Surgery Enquiry<br>
	<br>
	New Sign up
	<br>
	Name : $name;
	...
	<br>
	Mrs. Smirti - +91- 9454623563
	<br>
	Mr. Chetan Gharpinde - +91-7744010307
	<br>
	Dr. Ramdas Pawar - +91-9561584838
	<br>
	<br>
