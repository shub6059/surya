	...
	foreach ($meta_box_testi['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			echo '<tr style="border-top:1px solid #eeeeee;">',
				...
				'<td>';
			echo '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', $meta ? $meta : stripslashes(htmlspecialchars(( $field['std']), ENT_QUOTES)), '" size="3000" style="width:75%; margin-right: 20px; float:left;" />';
