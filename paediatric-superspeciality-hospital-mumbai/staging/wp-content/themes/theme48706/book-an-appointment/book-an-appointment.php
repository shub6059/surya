<?php /* Template Name: Book An Appointment */ ?>
<?php 
    
    $dbhost = "localhost";
    $dbname = "suryahos_wp";
    $dbuser = "suryahos_admin";
    $dbpass = "Webp!0neer";
    $db = "";
...
function filter(city) {
    if (city == "") {
        ...
        xmlhttp.open("GET","/wp-content/themes/theme48706/book-an-appointment/book_appointment_filtering.php?city="+city, true);
        xmlhttp.send();
    }
}
...
function filter2(speciality,city) {
    if (speciality == "" || city == "") {
        ...
        xmlhttp.open("GET","/wp-content/themes/theme48706/book-an-appointment/getSubSpeciality.php?speciality="+speciality+"&city="+city,true);
        xmlhttp.send();
    }   
}
...
function filter3(speciality,subSpeciality,city) {
    if (subSpeciality == "" || city == "" || speciality == "") {
        ...
        xmlhttp.open("GET","/wp-content/themes/theme48706/book-an-appointment/getDoctors.php?speciality="+speciality+"&subSpeciality="+subSpeciality+"&city="+city,true);
        xmlhttp.send();
    }   
}
</script>
	...
	<div class="container">
		<div class="row">
			<div class="<?php echo cherry_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="page-fullwidth.php" data-motopress-wrapper-type="content">
                ...
                ?>
				<form action="<?php echo "/wp-content/themes/theme48706/book-an-appointment/sendemail.php"; ?>" method="POST" >
					<div>
                	...
                	<div>
                    	<h4>Security Code:
                        <img src="/wp-content/themes/theme48706/book-an-appointment/CaptchaSecurityImages.php?width=125&height=50&characters=5" /></h4>
