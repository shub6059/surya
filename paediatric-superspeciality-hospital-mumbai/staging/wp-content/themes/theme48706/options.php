...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#d3cfcf'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '28px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a2a2a'));
			...
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a2a2a'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '42px', 'lineheight' => '42px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#cbeafd'));
...
//Authentication			
		$options[] = array( "name" => "Authentication",
							"id" => "authentication",
							"type" => "heading");
		...
		$options[] = array( "name" => "User profile link.",
					"desc" => "Please input user profile link title. If you use macro %username% it will be replaced with the current username. For example Site %username% .",
					"id" => "site_admin",
					"std" => "Site %username%",
					"class" => "tiny",
					"type" => "text");
					
		$options[] = array( "name" => "Logoff link.",
					"desc" => "Please input logoff link title.",
					"id" => "log_out",
					"std" => "Log out",
					"class" => "tiny",
					"type" => "text");
					
		$options[] = array( "name" => "Registration link.",
					"desc" => "Please input registration link title.",
					"id" => "sign_up",
					"std" => "Register",
					"class" => "tiny",
					"type" => "text");			
		
		$options[] = array( "name" => "Authentication link (login).",
					"desc" => "Please input authentication link title.",
					"id" => "sign_in",
					"std" => "Login",
					"class" => "tiny",
					"type" => "text");	
					
		$options[] = array( "name" => "Registration question.",
					"desc" => "Please input requstration question text.",
					"id" => "login_questions",
					"std" => "",
					"class" => "tiny",
					"type" => "text");
						
		$options[] = array( "name" => "Separator title.",
					"desc" => "Here you can define the text or symbol that will be used as a user links separator.",
					"id" => "word_delimiter",
					"std" => "",
					"class" => "tiny",
					"type" => "text");				
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#cbeafd'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#95cef0'));
			...
			$options[] = array(
				'name' => __('Mobile number in header : ', 'options_framework_theme'),
				'id' => 'mobile_number_in_header',
				'type' => 'text'
			);
			$options[] = array(
