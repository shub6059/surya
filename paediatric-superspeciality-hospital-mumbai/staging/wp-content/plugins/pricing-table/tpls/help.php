<div class="wrap">
    <div id="poststuff" style="float: left;overflow: hidden;font-size: 16px;line-height: 20px">
        <h2><?php _e('How to use Pricing Table','wppt'); ?></h2>
        <div style="margin-top: 10px;">
            <a class="ptpl" href="https://wpeden.com/product/wordpress-pricing-table-plugin-pro/" target="_blank">Check out Pricing Table <b><i>How To</i></b> videos here</a>
        </div>
        <div style="margin-top: 25px;">
            <a class="ptpl" href="https://wpeden.com/product/wordpress-pricing-table-plugin-pro/" target="_blank">Upgrade to PRO for 50+ Table Styles</a>
        </div>
        <style type="text/css">
        .tt {margin-left: 30px;}
        ...
        <br/>
        <br/>
        <code style="font-size: 14pt;">[ahm-pricing-table id=table_id template=template_name]</code>
        <br/>
        <br/>
        ...
        <b>OR you can just use custom tinyMCE button in Visual Editor Tab to insert table short-code</b>
        </div>
    </div>
