...
if(isset($_POST)){
	...
	$subject = 'Online Appointment Enquiry - Surya Hospitals Pune';
	...
	$to_email = $email;
	$subject = 'Surya Hospital, Pune | Thank you for your Enquiry';
	...
	Pune<br>
	<a href='https://suryahospitals.com/pune'>suryahospitals.com/pune</a>
	";
